package com.jorgeferraz.workshopmongo.config;
...
import com.jorgeferraz.workshopmongo.dto.AuthorDTO;
import com.jorgeferraz.workshopmongo.dto.ComentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		ComentDTO c2 = new ComentDTO("Aproveite bem"     , sdf.parse("22/03/2018"), new AuthorDTO( bob));
